//
//  PzCrashSignalExceptionHandler.m
//  PzKit
//
//  Created by sos1a2a3a on 2020/1/1.
//

#import "PzCrashSignalExceptionHandler.h"
#import <execinfo.h>
...
@implementation PzCrashSignalExceptionHandler
...
+ (void)signalRegister {
    PzSignalRegister(SIGABRT);
    PzSignalRegister(SIGBUS);
    PzSignalRegister(SIGFPE);
    PzSignalRegister(SIGILL);
    PzSignalRegister(SIGPIPE);
    PzSignalRegister(SIGSEGV);
    PzSignalRegister(SIGSYS);
    PzSignalRegister(SIGTRAP);
}
...
static void PzSignalRegister(int signal) {
    struct sigaction action;
    action.sa_sigaction = PzSignalHandler;
...
static void PzSignalHandler(int signal, siginfo_t* info, void* context) {
...
static void PzClearSignalRigister() {
